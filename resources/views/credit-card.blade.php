...
<body>
    @php
        $stripe_key = 'pk_test_51NIeWEAVmcPAOEIQr8hXDurP2D3dmfI6Jto3nrhd301GXm6ROIB7tbTD2hLu7wyUGFJaGfPrfQ8aZGBwWupAGpvL00cCqod9nQ';
    @endphp
            ...
            @endphp
                ...
                @if (session('success'))
                    <div class="alert alert-success alert-dismissible fade show text-center mt-4" role="alert">
                        {{ session('success') }}
                        {{-- @if ($BookSeat)
                            <a href="{{ route('reservations.download', ) }}"
